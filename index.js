...
function clickLeft() {
  ...
  document.querySelector(".project-container").style.left = `${newValue}px`;if (currentLeft === 0) { //si el valor de izquiera es 0, retornar para no seguir movierno el contenido
    return;
  }
